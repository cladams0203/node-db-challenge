...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
  1.)  A Relational database is a database with multiple tables, SQL is query language used to communicate to theos tables.

- [ ] Why do tables need a `primary key`?
  2.)  A primary key is needed to uniquely identify each row of a table.

- [ ] What is the name given to a table column that references the primary key on another table.
  3.)  foreign key

- [ ] What do we need in order to have a _many to many_ relationship between two tables.
  4.)  An intermediary table with a foreign key referencing the primary key of each table.
